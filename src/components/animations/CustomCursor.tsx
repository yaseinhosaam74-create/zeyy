      ...
      <AnimatePresence>
        {visible && (
          <motion.div
            ...
            style={{ x: pos.x - cfg.size / 2, y: pos.y - cfg.size / 2 }}
          ...
          >
            <motion.div
              animate={{ width: cfg.size, height: cfg.size, backgroundColor: cfg.filled ? "#38040E" : "transparent", borderColor: "#38040E" }}
              transition={{ duration: 0.25, ease: [0.25, 1, 0.5, 1] }}
              style={{ borderRadius: "50%", borderWidth: "1px", borderStyle: "solid", display: "flex", alignItems: "center", justifyContent: "center" }}
            >
              {cfg.label && (
                <motion.span initial={{ opacity: 0 }} animate={{ opacity: 1 }}
                  style={{ fontFamily: "Cormorant Garamond, serif", fontSize: "9px", letterSpacing: "0.15em", color: "#38040E" }}>
                  {cfg.label}
                </motion.span>
              )}
            </motion.div>
